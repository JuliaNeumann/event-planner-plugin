...
test("Event Planner Page shows an alert when no API response (user is not logged in) and does not display table",
    async t => {
        await t
...
test("Event Planner Static Page shows an alert when no API response (user is not logged in) and does not display table",
    async t => {
        await t
            .setNativeDialogHandler(() => true)
