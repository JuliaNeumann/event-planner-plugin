<template>
  <div class="edit-table-groups">
    ...
    <strong class="edit-table-groups__hint">
      Tabellenköpfe in einer Gruppe sollten möglichst in der Reihenfolge direkt nacheinander stehen (das macht die Tabelle übersichtlicher).<br>
    ...
    <button class="edit-table-groups__add" type="button" @click="addNewGroup">
      <i class="fa fa-fw fa-plus"></i>&nbsp;Tabellengruppe hinzufügen
    </button>                       
  </div>
</template>
